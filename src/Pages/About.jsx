...
export const About = () => {
  return (
    <div className="bg-[#9db4c0] min-h-screen flex flex-col items-center py-8">
      ...
      >
        <h1 className="text-4xl font-bold text-[#027c68] mb-6">About BloodSync</h1>
      ...
      <motion.div
        ...
        transition={{ duration: 0.8 }}
      >
        <h2 className="text-3xl font-bold text-[#027c68] mb-4">Our History</h2>
        <p className="text-gray-600 mb-4">
          BloodSync was founded in 2024 in response to the growing challenges of
          blood shortages and inefficient donation systems. What began as a
          small community project has now evolved into a trusted national
      ...
      >
        <div className="bg-white shadow-md rounded-lg p-6 w-80 text-center">
          <h2 className="text-xl font-bold text-[#027c68]">Real-Time Search</h2>
        ...
        <div className="bg-white shadow-md rounded-lg p-6 w-80 text-center">
          <h2 className="text-xl font-bold text-[#027c68]">Data-Driven Insights</h2>
          <p className="text-gray-600 mt-2">
        ...
        <div className="bg-white shadow-md rounded-lg p-6 w-80 text-center">
          <h2 className="text-xl font-bold text-[#027c68]">Global Network</h2>
          <p className="text-gray-600 mt-2">
            BloodSync connects donors and hospitals across india , 
            creating a unified national effort to save lives.
          </p>
        </div>
        <div className="bg-white shadow-md rounded-lg p-6 w-80 text-center">
          <h2 className="text-xl font-bold text-[#027c68]">Community Impact</h2>
          <p className="text-gray-600 mt-2">
            Join a network of over thousands of  registered donors committed to
      ...
      >
        <h2 className="text-3xl font-bold text-[#027c68] text-center mb-6">
          Testimonials
        </h2>
      ...
      >
        <h2 className="text-3xl font-bold text-[#027c68] mb-4">Our Vision</h2>
        <p className="text-gray-600">
