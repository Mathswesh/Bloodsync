...
export const Landingpage = () => {
    return (
        <div className="bg-gradient-to-r from-[#6f0000] to-[#200122] flex justify-center overflow-x-hidden">
        ...
        <div className='w-[1200px]'>    
            ...
            <div class="container mx-auto px-4 md:px-8 lg:px-16 grid grid-cols-3 grid-rows-3 gap-3">
                <div class="items-center justify-center flex col-span-2 row-span-2 rounded-md bg-white"><img src={img3} alt="" className='w-[200px]'/></div>
                <div class="items-center justify-center flex col-span-1 row-span-1 rounded-md bg-white"><img src={img3} alt="" className='w-[200px]'/></div>
                <div class="items-center justify-center flex col-span-1 row-span-2 rounded-md bg-white"><img src={img3} alt="" className='w-[200px]'/></div>
                <div class="items-center justify-center flex col-span-2 row-span-1 rounded-md bg-white"><img src={img3} alt="" className='w-[200px]'/></div>
            </div>
